<template lang="pug">
    header(class="px-6 lg:px-16 bg-white shadow flex justify-between flex-wrap items-center py-2 lg:py-0")
            ...
            nav
                ul(class="lg:flex items-center justify-between text-base text-gray-700 pt-4 lg:pt-0")
                    template(v-if="$auth.loggedIn")
                        HeaderLink Nastavení
                        HeaderLink Odhlásit se
                    template(v-else)
                        HeaderLink Přihlásit se
