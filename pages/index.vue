<template lang="pug">
    div
        header(class="px-6 lg:px-16 bg-white flex flex-wrap items-center py-2 lg:py-0")
            ...
            label(for="menu-toggle" class="cursor-pointer lg:hidden block")
                svg.fill-current.text-gray-900(xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20")
                    title menu
            ...
            div(class="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu")
                ...
                a(href="#" class="lg:ml-4 flex items-center justify-start lg:mb-0 mb-4 cursor-pointer")
                    img(src="https://pbs.twimg.com/profile_images/1128143121475342337/e8tkhRaz_normal.jpg"
                        alt="Avatar" class="rounded-full w-10 h-10 border-2 border-transparent hover:border-indigo-400")
        div.px-4
            div.max-w-3xl.bg-white.rounded-lg.mx-auto.my-16.p-16
                h1.text-2xl.font-medium.mb-2 Let's build some shit
                h2.font-medium.text-sm.text-indigo-400.mb-4.uppercase.tracking-wide Navbar
